...
class DENSENET19(Experiment):

    EXPERIMENT_NAME = "DENSENET19"
    ...
    def _createmodel(self, X_train, y_train, X_test, y_test, batch_size, epochs, **kwargs):
        ...
        model = densenet.DenseNet(classes=classes, input_shape = shape, depth=19, growth_rate=12, bottleneck=True, reduction=0.5)
